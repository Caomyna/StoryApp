...
public class StoryAdapter extends RecyclerView.Adapter<StoryAdapter.HolderStoryUser> implements Filterable {
    ...
    public void onBindViewHolder(@NonNull HolderStoryUser holder, int position) {
        ...
        Picasso.get().load(image).placeholder(R.drawable.ic_load).error(R.drawable.ic_image).into(holder.image);
